...
export default function OnboardingScreen() {
  ...
  async function submit() {
    ...
    try { setSubmitting(true); await completeOnboarding({ nickname, universityId, visaType, language }); router.replace('/(tabs)/today'); }
  ...
  return (
    <Screen>
      ...
      <Button loading={submitting} onPress={submit}>맞춤 홈 시작하기</Button>
